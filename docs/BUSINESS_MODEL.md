...
**Gelir akışları:**
1. **Kurulum ücreti** — birincil gelir, tek seferlik.
...
4. **Donanım marjı** (faz 2) — bundle içindeki donanımda üretici → HashTap
   → restoran zincirindeki fark.
5. **Ek modül / özellik satışı** (faz 3) — sadakat programı, delivery
